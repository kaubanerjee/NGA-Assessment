Feature: Learning Curve Read and Practice Quiz
    ...
    Scenario: Question Can Be a Mutiple Choice Question Correctly
    Scenario: Question Can Be a Mutiple Choice Question Incorrectly
    ...
    Scenario: Question Can Be a Sentense Click Question Correctly
    Scenario: Question Can Be a Sentense Click Question InCorrectly
    Scenario: Hint can be given
    Scenario: Mutiple Hints can be given on the same question
    Scenario: Quesstion can be skipped and answer given
